...
namespace POD.Data.Dapper
{
    ...
    {
        public static PODContext GetContext(bool withTransaction)
        {
            #region Verify state
            ...
            return new PODContext(_connectionString, _dbEngine, withTransaction);
        }
        ...
        {           
            ...
            if (!Enum.TryParse<Enums.DbEngine>(db, out _dbEngine))
            {
        ...
        static Enums.DbEngine _dbEngine;
